...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_BuildMenu.enabled, "This will cause a leak and performance issues, InputSystem_Actions.BuildMenu.Disable() has not been called.");
    }
    ...
    public struct BuildMenuActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public BuildMenuActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
